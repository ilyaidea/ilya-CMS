...
$(document).ready(function () {
	 ...
	 */
	$('#qam-sidepanel-right-toggle').click(function () {
		$('#qam-sidepanel-right-mobile').toggleClass('open');
		$(this).toggleClass('active');
		$(this).find('i').toggleClass('icon-right-open-big');
	});
    $('#qam-sidepanel-left-toggle').click(function () {
        $('#qam-sidepanel-left-mobile').toggleClass('open');
        $(this).toggleClass('active');
