<ul class="nav-right">
    <?php if (!isset($languages_disabled)) { ?>
        <?= $this->partial('navbar/wrapper/container/right/languages') ?>
    <?php } ?>
    ...
    <?= $this->partial('navbar/wrapper/container/right/chatbox') ?>
    <?= $this->partial('navbar/wrapper/container/right/user-profile') ?>
</ul>